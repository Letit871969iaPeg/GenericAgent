...
> 我个人在 Python 3.11.9 上测试通过，建议优先选 3.11。
...
> 💡 **提示**：`mykey.py` 已在 `.gitignore` 中，不会被 git 追踪，密钥不会意外上传。
...
> 可以在 VS Code 中右键项目文件夹选 "在集成终端中打开" 来自动切换。
>
> 💡 **个人备注**：首次运行可能会自动安装依赖，耗时较长属正常现象，等待即可。
